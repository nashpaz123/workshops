...
```bash
[root@ansible ansible-files]$ ansible-doc -l | grep -i user
[root@ansible ansible-files]$ ansible-doc user
[root@ansible ansible-files]$ ansible node1,node3 -m user -a "name=testuser comment='Test D User'" -b
[root@ansible ansible-files]$ ansible node1,node3 -m command -a " id testuser" -b
[root@ansible ansible-files]$ ansible node2 -m command -a " id testuser" -b
[root@ansible ansible-files]$ ansible node1,node3 -m user -a "name=testuser state=absent remove=yes" -b
[root@ansible ansible-files]$ ansible web -m command -a " id testuser" -b
```
...
```bash
[root@ansible ansible-files]$ ansible-playbook apache_config_tpl.yml
[...]
[root@ansible ansible-files]$ curl http://18.195.235.231:8080
<body>
<h1>This is a development webserver, have fun!</h1>
</body>
[root@ansible ansible-files]$ curl http://35.156.28.209:80
<body>
